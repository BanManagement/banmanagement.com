...
## Prerequisites
- Java 8+
    - [CraftBukkit/Spigot/Paper](https://www.spigotmc.org/wiki/buildtools/) for Minecraft 1.7.2+
    - [Sponge API 7](https://www.spongepowered.org/downloads/) for Minecraft 1.12.2
- Java 17+
    - [Sponge API 11+](https://www.spongepowered.org/downloads/) for Minecraft 1.20+
    - [Fabric](https://fabricmc.net/use/installer/) for Minecraft 1.20.1, 1.21.1, 1.21.4
