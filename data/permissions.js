const permissions = [
  ...
  ['bm.command.delete.baniprecords', 'Allows deleting the ban records of an ip'],
  ...
  ['bm.exempt.override.kick', 'Allows a player to kick an exempt player'],
  ['bm.exempt.ban', 'Online players with this permission cannot be banned, highly recommended for admins'],
  ['bm.exempt.override.ban', 'Allows a player to ban an exempt player'],
  ['bm.exempt.tempban', 'Online players with this permission cannot be temporarily banned,highly recommended for admins'],
  ['bm.exempt.override.tempban', 'Allows a player to tempban an exempt player'],
  ['bm.exempt.maxonlineperip', 'Allows a player to bypass the maxOnlinePerIp configuration option'],
  ['bm.exempt.maxmultiaccountsrecently', 'Allows a player to bypass the maxMultiaccountsRecently configuration option'],
  ['bm.exempt.mute', 'Online players with this permission cannot be muted, highly recommended for admins'],
  ['bm.exempt.override.mute', 'Allows a player to mute an exempt player'],
  ['bm.exempt.muteip', 'Online players with this permission cannot have their ip address muted, highly recommended for admins'],
  ['bm.exempt.override.muteip', 'Allows a player to mute the ip address an exempt player'],
  ['bm.exempt.tempmuteip', 'Online players with this permission cannot have their ip address temporarily muted, highly recommended for admins'],
  ['bm.exempt.override.tempmuteip', 'Allows a player to temporarily mute the ip address an exempt player'],
  ['bm.exempt.tempmute', 'Online players with this permission cannot be temporarily muted, highly recommended for admins'],
  ['bm.exempt.override.tempmute', 'Allows a player to tempmute an exempt player'],
  ...
  ['bm.exempt.override.tempwarn', 'Allows a player to temporarily warn an exempt player'],
  ['bm.exempt.report', 'Online players with this permission cannot be reportd, highly recommended for admins'],
  ['bm.exempt.override.report', 'Allows a player to report an exempt player'],
