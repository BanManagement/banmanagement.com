const commands = [
  ...
  ['/bmclear <player> [banrecords || baniprecords || kicks || muterecords || notes || reports || warnings]', 'Clear all records of a player or specify a type', '', 'bm.command.clear'],
  ['/bmdelete <banrecords || baniprecords || kicks || muterecords || notes || reports || warnings> <ids>', 'Delete specific records for a player based on ids from /bminfo', '', 'bm.command.delete'],
