...
function Page ({ isMobileFromSSR }) {
  return (
    <DefaultLayout title='Support' isMobileFromSSR={isMobileFromSSR} description='Raise issues on GitHub or request support via Discord'>
      <Segment vertical>
        <Container text>
          ...
          <p>Having trouble setting something up? Have questions? <a href='https://discord.gg/59bsgZB'>Join the BanManager Discord server</a></p>
