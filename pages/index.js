...
function Page ({ isMobileFromSSR }) {
  return (
    <DefaultLayout title='Ban Management' heading={Heading} isMobileFromSSR={isMobileFromSSR} description='A suite of Minecraft plugins for server owners to manage punishments with ease, supporting Bukkit, BungeeCord and Sponge'>
